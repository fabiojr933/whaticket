    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: "#1E90FF" },
                textPrimary: mode === "light" ? "#1E90FF" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#1E90FF" : "#FFFFFF",
                dark: { main: mode === "light" ? "#333333" : "#F3F3F3" },
                light: { main: mode === "light" ? "#F3F3F3" : "#333333" },
                tabHeaderBackground: mode === "light" ? "#EEE" : "#333",
                optionsBackground: mode === "light" ? "#fafafa" : "#333",
				options: mode === "light" ? "#fafafa" : "#666",
				fontecor: mode === "light" ? "#1E90FF" : "#fff",
                ...
                barraSuperior: mode === "light" ? "linear-gradient(to right, #1E90FF, #0000CD, #00008B)" : "#666",
